TGraphErrors * N63(int replay, int bin, double eMin, double eMax, double & ymin, double & ymax, TGraphErrors * &g,TGraphErrors * &gA, TGraphErrors * &gB, TGraphErrors * &gSpec,TGraphErrors * &gint, TGraphErrors *& gintA, TGraphErrors *& gintB){
  double vint = 0;
  double vinte = 0;
  double vintA = 0;
  double vintAe = 0;
  ...
  for(int i = 0; i<12; i++) {
    ...
    //for five subevent calculations N63B and N63C, only the A calculation has the correct resulution calculation  
    gint->GetY()[i] = vint;
    gint->GetEY()[i] = vinte;
    gintA->GetY()[i]=vintA;
